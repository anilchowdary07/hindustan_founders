      ...
      {activeChat && (
        <>
          ...
          <div className="px-4 py-2 border-b dark:border-gray-700 flex items-center gap-3">
            ...
            <div>
              <h4 className="font-medium dark:text-white">{contacts.find(c => c.id === activeChat)?.name}</h4>
                ...
                <div 
                  className={`max-w-[80%] rounded-lg p-3 ${
                    msg.isCurrentUser 
                      ...
                      : 'bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-bl-none dark:text-gray-100'
                  }`}
                >
                  <p className="text-sm">{msg.text}</p>
                  <p className={`text-xs mt-1 ${msg.isCurrentUser ? 'text-primary-100' : 'text-gray-500 dark:text-gray-400'}`}>
