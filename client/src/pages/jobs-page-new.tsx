            ...
            <Tabs defaultValue="search" className="w-full">
              ...
              <TabsContent value="recommended" className="mt-0">
                <div className="space-y-4">
                  {[1, 2, 3].map((job) => (
                    <div key={job} className="flex items-center justify-between p-3 border border-[#E0E0E0] rounded-lg hover:bg-[#F3F2EF] transition-colors">
                      <div className="flex items-center">
                        <Avatar className="h-12 w-12 rounded-md border border-[#E0E0E0]">
                          <AvatarFallback className="bg-[#F3F2EF] text-[#0A66C2] font-semibold">
                            {job === 1 ? "RZ" : job === 2 ? "ZD" : "CR"}
                          </AvatarFallback>
                        </Avatar>
                        <div className="ml-3">
                          <h4 className="font-semibold text-[#0A66C2] hover:underline cursor-pointer">
                            {job === 1 ? "Senior React Developer" : job === 2 ? "Full Stack Engineer" : "Node.js Developer"}
                          </h4>
                          <p className="text-[#191919]">
                            {job === 1 ? "Razorpay" : job === 2 ? "Zerodha" : "CRED"}
                          </p>
                          <div className="flex items-center text-xs text-[#666666]">
                            <ThumbsUp className="h-3 w-3 mr-1 text-[#0A66C2]" />
                            <span className="text-[#0A66C2] font-medium mr-1">
                              {job === 1 ? "92%" : job === 2 ? "87%" : "85%"}
                            </span>
                            match for you
                          </div>
                        </div>
